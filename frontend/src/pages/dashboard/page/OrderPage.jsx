...
const OrderPage = () => {
    const { menu, getAllMenuItems, category: categoriesList, getAllCategories, isMenuLoading, paginationMenu } = useMenuStore();
    ...
    const handlePlaceOrder = async () => {
        ...
        if (result?.success) {
            ...
            toast.error(result?.message || "Failed to place order. Try emptying your cart and adding items again.");
        }
    };
