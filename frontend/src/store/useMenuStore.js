...
export const useMenuStore = create((set) => ({
    isLoading: false,       // kept for backward compat (menu items)
    isMenuLoading: false,   // dedicated flag for menu item fetches
    isCategoryLoading: false, // dedicated flag for category fetches
    error: null,
    menu: [],
    category: [],
    paginationMenu: {
    ...
    getAllMenuItems: async (page = 1, limit = 10, categoryId = "", search = "", isAvailable = "") => {
        set({ isLoading: true, isMenuLoading: true, error: null });
        try {
